...
urlpatterns = [
    ...
    path("detailedStatistics/", get_map_json_statistics, name="mapJsonStatistics"),
    path("detailedStatistics/<str:measure>", get_map_json_statistics, name="mapJsonStatistics"),
